...
public class CircularFIFOTemplateInc1 implements InitTemplate {
  ...
  public CircularFIFOTemplateInc1() {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nThe field CircularFIFOTemplateInc1.typeVertexSet refers to the missing type Vertex"
  ...
  public String create() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe field CircularFIFOTemplateInc1.typeVertexSet refers to the missing type Vertex"
      + "\nThe field CircularFIFOTemplateInc1.typeVertexSet refers to the missing type Vertex"
      + "\nThe method foo(Vertex) from the type CircularFIFOTemplateInc1 refers to the missing type Vertex");
  }
